...
export default function ContactForm() {
  ...
  return (
    <div>
      {/* <Disclosure> */}
      <div className=" flex flex-col overflow-hidden left-0 h-full w-full border border-gray-300 dark:border-gray-800 bg-white shadow-md rounded-md max-w-2xl m-auto">
