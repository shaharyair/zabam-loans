  ...
  return (
    <div className="w-full">
      <nav className="container relative flex flex-wrap items-center justify-between p-4 mx-auto lg:justify-between xl:px-1">
        ...
        <Link href="/">
          <span>
            <Image src={zabamLogo} width="500" alt="Zabam Loans" height="500" className="w-24 h-auto" />
          </span>
        </Link>
        ...
        <div className="gap-3 nav__item mr-2 lg:flex ml-auto lg:ml-0 lg:order-2">
          ...
          <div className="hidden mr-3 lg:flex nav__item">
            <Link href="/#benefit-one" className="px-6 py-2 text-white bg-indigo-600 rounded-md md:ml-5">
              Get Started
            </Link>
          </div>
        </div>
